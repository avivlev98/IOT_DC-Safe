...
if __name__ == '__main__':
    if db_init:
        ...
        numb =create_IOT_dev('TEMP-SENSOR', 'on', 'celcius', timestamp(), 300, 'address', 'building', 'room', 'placed', 'detector', 'enabled', 'state', 'mode', 'fan', 'temperature', comm_topic+'TEMP-SENSOR/pub', comm_topic+'TEMP-SENSOR/sub', 'done')
        numb =create_IOT_dev('RACK-SENSOR', 'on', 'celcius', timestamp(), 300, 'address', 'building', 'room', 'placed', 'detector', 'enabled', 'state', 'mode', 'fan', 'temperature', comm_topic+'RACK-SENSOR/pub', comm_topic+'RACK-SENSOR/sub', 'done')
        numb =create_IOT_dev('ELECTRICITY-SENSOR', 'on', 'kWh', timestamp(), 300, 'address', 'building', 'room', 'placed', 'detector', 'enabled', 'state', 'mode', 'fan', 'NA', comm_topic+'ELECTRICITY-SENSOR/pub', comm_topic+'ELECTRICITY-SENSOR/sub', 'done')
        numb =create_IOT_dev('WATER-SENSOR', 'on', 'm3', timestamp(), 3600, 'address', 'building', 'room', 'placed', 'meter', 'enabled', 'state', 'mode', 'fan', 'NA', comm_topic+'WATER-SENSOR/pub', comm_topic+'WATER-SENSOR/sub', 'done')
